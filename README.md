...
| [`D4np\Utils\Security\`](src/main/php/d4np/utils/Security/) | `Escaper` (four contexts), `Sanitizer`, `Hash` (Argon2id), `Crypto` (AES-256-GCM), `Hmac` (detached signatures) — both with `SecretKeyRing` key rotation |
