...
- [ ] [#96](https://github.com/danielPoloWork/egl-util-php/issues/96) **feat: sortable identifiers — Str::ulid() and Str::uuidV7() — M14 candidate** — **M14 item 14.2** (FR-46) — intra-millisecond monotonicity ruled OUT of scope by RFC-0003 — route: frontier-reasoning / extra
- [ ] [#95](https://github.com/danielPoloWork/egl-util-php/issues/95) **feat: pagination value objects in Persistence — M14 candidate** — **M14 item 14.3** (FR-47) — sized down: QueryBuilder already has limit()/offset(), no new SQL door — route: frontier-reasoning / extra
- [ ] [#94](https://github.com/danielPoloWork/egl-util-php/issues/94) **feat: retry/backoff policy object in Support — M15 candidate** — **M14 item 14.5** (FR-49) — depends on 14.1; wall-clock deadline required, not just attempt count — route: frontier-reasoning / extra
...
- [ ] [#92](https://github.com/danielPoloWork/egl-util-php/issues/92) **feat: HMAC signing utility (signed URLs, webhook signatures) — M14/M15 candidate** — **M14 item 14.4** (FR-48) — does NOT block on #114: ADR-0054's versioned prefix absorbs key ids as v2 — route: frontier-reasoning / extra
- [ ] [#91](https://github.com/danielPoloWork/egl-util-php/issues/91) **feat: rate-limiting primitive (token bucket / fixed window) — M15 candidate** — **reopened 2026-08-13** (the deferral's revisit condition was unreachable — the seam it waited for is this issue's own deliverable); design settled in ADR-0061 as **M14 item 14.6**, implementation is **14.7** after 14.1's clock — route: frontier-reasoning / extra
