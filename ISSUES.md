...
- [ ] [#97](https://github.com/danielPoloWork/egl-util-php/issues/97) **feat: PSR-20 clock in Support (SystemClock / FrozenClock) — M14 candidate** — **M14 item 14.1** (FR-45) — the keystone: three other candidates need a clock and none exists — route: frontier-reasoning / extra
